...
export const createPreOrder = async (req, res) => {
    try {
        ...
        if (!userId)
            return;
        const { productId, quantity, pickupDate, pickupTime, notes } = req.body;
...
export const getSellerPreOrders = async (req, res) => {
    try {
        const userId = ensureUserId(req, res);
        if (!userId)
            return;
...
export const acceptPreOrder = async (req, res) => {
    try {
        const userId = ensureUserId(req, res);
        if (!userId)
            return;
...
export const getCustomerPreOrders = async (req, res) => {
    try {
        const userId = ensureUserId(req, res);
        if (!userId)
            return;
...
//# sourceMappingURL=preOrderController.js.map