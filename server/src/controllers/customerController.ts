...
export const getCustomerAddresses = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = ensureUserId(req, res);
    if (!userId) return;
...
export const createCustomerAddress = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = ensureUserId(req, res);
    if (!userId) return;
...
export const updateCustomerAddress = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = ensureUserId(req, res);
    if (!userId) return;
...
export const deleteCustomerAddress = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = ensureUserId(req, res);
    if (!userId) return;
...
export const searchProducts = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { q, category, shop } = req.query as { q?: string; category?: string; shop?: string };
...
export const searchShops = async (req: AuthenticatedRequest, res: Response) => {
  try {
